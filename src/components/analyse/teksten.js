...
export const TEKST = {
  nl: {
    ...
    kGedeeldeApps: 'Applicaties gebruikt door meerdere teams',
    uGedeeldeApps: 'Uit het centrale applicatieregister: applicaties die bij meer dan een team in de werkstroom staan, met het hoogste risico van de dependencies die eraan hangen. Gesorteerd op aantal teams.',
    geenGedeeldeApps: 'Geen enkele applicatie staat bij meer dan een team. Is het register nog leeg, draai dan eerst de omzetting in Instellingen.',
    aantalTeams: 'Teams',
  ...
  en: {
    ...
    kGedeeldeApps: 'Applications used by several teams',
    uGedeeldeApps: 'From the central application register: applications that appear in more than one team’s workflow, with the highest risk of the dependencies attached to them. Sorted by number of teams.',
    geenGedeeldeApps: 'No application appears at more than one team. If the register is still empty, run the conversion in Settings first.',
    aantalTeams: 'Teams',
