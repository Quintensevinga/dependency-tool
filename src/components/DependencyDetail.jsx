    ...
    <div className="fixed inset-0 z-40 flex justify-end bg-stone-900/30" onClick={onClose}>
      ...
      >
        <div className="flex items-start justify-between border-b border-stone-200 px-5 py-4">
          <div>
            <div className="text-xs font-medium text-stone-400">{dependency.team}</div>
            <h3 className="mt-0.5 text-base font-semibold text-stone-900">{dependency.titel}</h3>
          </div>
        ...
        <div className="flex-1 space-y-4 px-5 py-4">
          ...
          <Field label={t('detail.rol')} value={dependency.rol_betrokkene} />
